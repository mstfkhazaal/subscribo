    ...
    */
    ...
    'features' => [
        ...
        Features::resetPasswords([
            ...
            'reset' => [
                'page' => \Mstfkhazaal\FilamentJet\Filament\Pages\Auth\PasswordReset\ResetPassword::class,
                'card_width' => 'md',
                'has_brand' => true,
                'rate_limiting' => [
                    'enabled' => true,
        ...
        //     'page' => \Mstfkhazaal\FilamentJet\Filament\Pages\Auth\EmailVerification\EmailVerificationPrompt::class,
        //     'controller' => \Mstfkhazaal\FilamentJet\Http\Controllers\Auth\EmailVerificationController::class,
        //     'card_width' => 'md',
        //     'has_brand' => true,
        //     'rate_limiting' => [
        //         'enabled' => true,
        ...
        Features::teams([
            ...
            'middleware' => ['verified'],
            'invitation' => [
                'controller' => \Mstfkhazaal\FilamentJet\Http\Controllers\TeamInvitationController::class,
                'actions' => [
                    'accept' => 'accept',
                    'destroy' => 'destroy',
                ],
